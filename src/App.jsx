...
export default function KingdomOS() {
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: T.bg, color: T.text, colorScheme: theme === "dark" ? "dark" : "light", height: "100dvh", maxWidth: 480, margin: "0 auto", position: "relative", overflow: "hidden" }}>
      <style>{FONTS}</style>
